...
public enum UserPersonRelativeSyncRule {
    ...
    private UserPersonRelativeSyncRule(Integer code, String description) {
        this.code = code;
     ...
     * @author xiazhitao
     */
    public static UserPersonRelativeSyncRule parse(Integer code) {
        if (code == null) {
            return UserPersonRelativeSyncRule.UNKNOWN;
        }
        for (UserPersonRelativeSyncRule formType : values()) {
    ...
    public static String transferFilters(String str) {
        ...
        String result = str;
        for (UserPersonRelativeSyncRule val : values()) {
